...
def run_all_tests(test_path: Optional[str] = None, verbose: bool = False) -> bool:
    ...
    if test_path is None:
        ...
        test_modules = [
            ...
            'tests.router.test_synthetic_smart_router_tool',
            'tests.router.test_website_smart_router',
            'tests.synthetic.test_synthetic_catalog',
            'tests.synthetic.test_synthetic_settings',
            'tests.synthetic.test_synthetic_metrics',
            'tests.synthetic.test_synthetic_test_playback_results',
            ...
            'tests.prompts.synthetic.test_synthetic_catalog_prompts',
            'tests.prompts.synthetic.test_synthetic_metrics_prompts',
            'tests.prompts.synthetic.test_synthetic_settings_prompts',
            'tests.prompts.synthetic.test_synthetic_test_playback_results_prompts',
        ]
